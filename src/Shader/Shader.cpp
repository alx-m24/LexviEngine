...
void Lexvi::Shader::setiVec2(const std::string& name, const glm::ivec2& value) const
{
...
uint64_t Lexvi::GetMaxThreadsPerDispatch(int localSizeX, int localSizeY, int localSizeZ)
{
